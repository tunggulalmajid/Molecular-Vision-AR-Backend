...
<template>
    ...
    <div class="flex min-h-screen w-full flex-col font-sans lg:flex-row">
        ...
        <div
            class="relative flex w-full flex-col justify-between overflow-hidden bg-[#0e2338] p-8 sm:p-12 lg:w-[50%] lg:min-h-screen lg:p-14 xl:p-16"
        >
            <!-- Decorative Background Circular Elements -->
            <div
                class="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full bg-[#091827]/60"
            />
            <div
                class="pointer-events-none absolute -bottom-36 -left-36 h-[460px] w-[460px] rounded-full bg-[#081522]/80"
            />
            <div
                class="pointer-events-none absolute -right-24 top-1/2 h-80 w-80 -translate-y-1/2 rounded-full bg-[#0a1b2b]/50"
            />
            ...
            <div class="relative z-10 space-y-3 pt-6 lg:pt-0">
                ...
                >
                    <template #icon>
                        <LineChart class="h-4.5 w-4.5 text-slate-300" :size="18" />
                    </template>
                </FeaturePill>
            </div>
        </div>
        ...
        <div
            class="flex w-full flex-1 flex-col justify-between bg-[#07111b] p-6 sm:p-12 lg:w-[50%] lg:min-h-screen lg:p-14 xl:p-16"
        >
            <!-- Top empty space for balance on desktop -->
            <div class="hidden lg:block" />

            <!-- Main Form Card -->
            <div class="my-auto w-full max-w-sm sm:max-w-md mx-auto">
                <div class="mb-6">
                    <h2
            ...
            <footer class="mt-8 text-center">
                <p class="text-[11px] text-slate-500 sm:text-xs">
                    © 2026 Molecular Vision AR — Sistem Manajemen Konten Akademik
                </p>
            </footer>
        </div>
    </div>
