            ...
            <div class="flex items-start gap-3.5 rounded-lg border border-rose-500/20 bg-rose-500/10 p-3.5">
                ...
                <div class="text-sm text-slate-300">
                    ...
                    <p class="mt-0.5 text-xs text-slate-300">
                        ...
                        <span class="font-bold text-rose-300 capitalize">{{ role?.name }}</span>?
                    </p>
                </div>
            </div>

            <p class="text-xs text-slate-400">
                Peran yang dihapus tidak dapat dipulihkan. Pastikan tidak ada pengguna yang sedang menggunakan peran ini.
            </p>
