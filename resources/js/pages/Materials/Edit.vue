...
import type { MaterialItem } from './DeleteMaterialModal.vue';
...
const form = useForm({
    ...
    id_category: props.material.id_category || '',
    description: props.material.description || '',
    content: props.material.content || '',
});

const submit = () => {
    form.put(route('materials.update', props.material.id_material), {
        preserveScroll: true,
    });
};
</script>
...
<template>
    <Head :title="`Edit Materi: ${material.name}`" />
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-slate-400">
                            Perbarui konten modul, video panduan, atau informasi
                            ringkasan materi #{{ material.id_material }}.
                        </p>
                    </div>
                </div>
            </div>
                ...
                >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="2"
                            maxlength="500"
                            placeholder="Tuliskan ringkasan pengantar materi..."
