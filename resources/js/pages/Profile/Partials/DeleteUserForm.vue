...
<template>
    <section
        class="rounded-xl border border-rose-500/20 bg-[#091624] p-6 shadow-xl sm:p-8"
    >
        <header class="border-b border-rose-500/20 pb-4">
            ...
            <p class="mt-1 text-xs text-slate-400">
                Setelah akun Anda dihapus, semua data dan sesi login Anda akan
        ...
        >
            <p class="max-w-xl text-xs text-slate-400">
                ...
                mempertimbangkan sebelum melanjutkan penghapusan akun.
            </p>
            <button
                type="button"
                @click="confirmUserDeletion"
                class="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-rose-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-rose-600/20 transition-all hover:bg-rose-500 focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 focus:ring-offset-[#091624] focus:outline-none"
            >
        ...
        >
            <div class="space-y-4">
                <div
                    class="flex items-start gap-3 rounded-lg border border-rose-500/20 bg-rose-500/10 p-3.5"
                >
                    <AlertTriangle class="h-5 w-5 shrink-0 text-rose-400" />
                    <p class="text-xs text-slate-300">
                        Apakah Anda yakin ingin menghapus akun Anda? Masukkan
